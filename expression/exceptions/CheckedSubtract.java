...
public class CheckedSubtract extends Subtract {
    ...
    public CheckedSubtract(PriorityOperation expression1, PriorityOperation expression2) {
    ...
    public int evaluate(int x, int y, int z) {
        ...
        if (evalExpr2 < 0 && evalExpr1 > Integer.MAX_VALUE + evalExpr2 ||
            ...
            throw new OverflowException(this + ": can't subtract " + evalExpr1 + " = " + expression1 + " and " + evalExpr2 + " = " + expression2);
        }
